...
<head>
  ...
  <title>Villa Santera  | Dashboard</title>
        ...
        <li class="active">
         ...
         <li class="treeview">
          ...
          <ul class="treeview-menu">
             <li><a href="<?php echo base_url().'admin/tiket/tiket_aktif'?>"><i class="fa fa-check"></i> Booking Aktif</a></li>
             <li><a href="<?php echo base_url().'admin/tiket/tiket_tunggu'?>"><i class="fa fa-envelope"></i> Menunggu Persetujuan</a></li>
