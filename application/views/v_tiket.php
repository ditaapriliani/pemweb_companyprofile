...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center mb-5">
    <div class="container" data-aos="fade-in">
      <h1>DATA BOOKING VILLA</h1>
    <h2>Cari Data Bookingmu dengan mengetik No Telfon atau email</h2>
          ...
          <div class="card mb-" style="max-width: 540px;">
            <div class="row no-gutters">
              ...
              <div class="card-body">
                  ...
                  <div class="col-lg-9">
                    ...
                    <?php elseif ($tiket['status']==2): ?>
                      <form action="<?php echo base_url('tiket/laporan_pdf');?>" method="post" target="blank">
                        ...
                        <button type="submit" name="submit" class="btn btn-sm btn-danger ">Cetak Bukti Booking</button>
                      </form>
                    <?php endif;?>
                   </div>
                </div>
                ...
                <?php elseif($tiket['status']==2):?>
                  <a data-toggle="modal" data-target="#modalaktif"  class="btn btn-sm btn-success text-white">Booking Aktif</a>
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><I class="fa fa-user"></i> Detail Booking</h5>
              ...
              <form action="<?= base_url('tiket/add');?>" method ="POST">
               <div class="form-group">
                 <h1><b><center><?=$tkt['id_tiket'];?></center></b></h1><hr>
                  ...
                  <div class="form-group">
                    <label for="tgl_kunjungan">Tanggal Booking</label>
    ...
    <?php foreach ($tikets as $tkt):?>
        <div class="modal fade" id="modalpembayaran<?=$tkt['id_tiket'];?>" tabindex="-1" role="dialog" aria-labelledby="modalTambah" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel"><I class="fa fa-user"></i> KONFIRMASI PEMBAYARAN BOOKING</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><i class='fa fa-times-circle'></i></button>
              </div>
              <div class="modal-body p-4">
                <div class="alert alert-primary" role="alert">
                      Data konfirmasi booking tidak bisa diubah, <strong>pastikan anda mengisi data dengan benar!</strong>
                  </div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="alert alert-primary" role="alert">
                Hi, Data booking kamu belum mendapat konfirmasi dari admin, mohon bersabar ya :)
              </div>
              </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="alert alert-success" role="alert">
                Hi, booking kamu sudah aktif, silahkan datang ke lokasi sesuai tanggal dan jam check-in :)
              </div>
              </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
