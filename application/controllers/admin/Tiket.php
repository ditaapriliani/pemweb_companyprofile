...
class Tiket extends CI_Controller{
	...
	public function tiket_dipesan(){
		$x['tittle']="Data Booking (Belum Dibayar)";
	...
	public function tiket_tunggu(){
		$x['tittle']="Data Booking (Menunggu Konfirmasi)";
	...
	public function tiket_ditolak(){
		$x['tittle']="Data Booking (Pembayaran Gagal)";
	...
	public function tiket_digunakan(){
		$x['tittle']="Data Booking (Sudah Digunakan)";
